...
import {IconBug, IconMoon, IconSun, IconUserCircle} from '@tabler/icons-react';
...
export default function Login() {
    ...
    return (
        <div className='flex flex-col flex-1 items-center justify-center gap-4 bg-background min-h-screen'>
            ...
            <form onSubmit={handleSubmit} className='bg-card text-foreground border border-border rounded-2xl p-20 flex flex-col items-center gap-4'>
